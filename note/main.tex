...
\begin{document}
    ...
    \begin{abstract}
        ...
        This Git repository is the supplementary material of Ref.~\cite{Bernal:2025_prethermalized-gravitational-waves}.
    ...
    \section{Introduction}
        ...
        This note adopts the convention of $(+ + +)$ instead of $(- - +)$ in Ref.~\cite{Bernal:2025_prethermalized-gravitational-waves}.
    ...
    \section{Amplitudes}
        ...
        \subsection{\boldmath \texorpdfstring{\boldmath $\phi + \varphi \to h_{\mu\nu} + \varphi$}{ϕ + φ → h\_{µν} + φ}}
            ...
            \paragraph{Important Note:}
            In this note, the designations for the $t$-channel and the $u$-channel are precisely the opposite of those used in Ref.~\cite{Bernal:2025_prethermalized-gravitational-waves}.
            More specifically, the $t$-channel in this note corresponds to the $u$-channel in Ref.~\cite{Bernal:2025_prethermalized-gravitational-waves}, while the $u$-channel in this note corresponds to the $t$-channel in Ref.~\cite{Bernal:2025_prethermalized-gravitational-waves}.
    ...
    \addcontentsline{toc}{section}{Acknowledgments}
        ...
        This note in \faGithub~\githubsrc{} is the supplementary material of Ref.~\cite{Bernal:2025_prethermalized-gravitational-waves}, so I would like to thank my collaborators Nicolás Bernal, Yong XU, and Xun-Jie XU for useful discussion on this work.
