...
\begin{document}
    ...
    \section{Amplitudes}
        ...
        \subsection{\boldmath \texorpdfstring{\boldmath $\phi + \varphi \to h_{\mu\nu} + \varphi$}{ϕ + φ → h\_{µν} + φ}}
            ...
            \paragraph{Important Note:}
            In this note, the designations for the $t$-channel and the $u$-channel are precisely the opposite of those used in Ref.~\cite{Bernal:2025lxp}.
            More specifically, the $t$-channel in this note corresponds to the $u$-channel in Ref.~\cite{Bernal:2025lxp}, while the $u$-channel in this note corresponds to the $t$-channel in Ref.~\cite{Bernal:2025lxp}.
